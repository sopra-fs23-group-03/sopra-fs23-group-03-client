...
### Profile
In the personal profile a user can change the name and password. More interesting though are the options to define diet preferences, allergies, and favourite cuisine. This information will taken into acount during the recipe selection.
